...
@Autonomous(name="BlueNearGoalOld", group="Auto", preselectTeleOp="ATHENS TwoCon_Teleop_1400 6nov25")
@Disabled
public class BlueNearGoalOld extends OpMode {
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                intake.run();
                this.artifact.sleep(500);
                shooter.start(shooterPower, shooterVelocityWall);
                setPathState(1);
                break;
            case 1:
                if(shooter.getVelocity() > (shooterVelocityWall*0.8 )){

...
@Autonomous(name="BlueNearGoal_Limelight", group="Auto", preselectTeleOp="Comb_TwoCon_Teleop_Cam 947 29nov25")
@Disabled
public class BlueNearGoal_Limelight extends OpMode {
 ...
 */
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            case 0:
                ...
                break;
            case 1:
                artifactNew.shootArtifact(0.0, shooterVelocityWall,
                                   -1,-1,-1 );
            ...
            case 4:
                ...
                if(!follower.isBusy()){
                    //intake.stop();
                    artifactNew.setAprilTag(aprilTagDetected);
            ...
            case 5:
                if(!follower.isBusy()){
                    artifactNew.shootArtifact(shooterPower, shooterVelocityWall,
    ...
    public void init() {
        ...
        int aprilTagDetected = getMotifAprilTag();
        artifactNew = new ArtifactNew(hardwareMap,aprilTagDetected, this.sleepTimer, telemetry);

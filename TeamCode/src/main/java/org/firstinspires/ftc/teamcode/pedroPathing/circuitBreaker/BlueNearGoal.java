...
/* private final Pose startPose = new Pose(16, 111, Math.toRadians(90));
    ...
    */
    ...
    private final Pose startPose = new Pose(16, 111, Math.toRadians(90));
    private final Pose shootPose1 = new Pose(35,120, Math.toRadians(140));
    ...
    private final Pose shootPose2 = new Pose(35,120,Math.toRadians(140));
    private final Pose intermediatePose2 = new Pose(24,72,Math.toRadians(-90));
    private final Pose controlPose2 = new Pose(40,80);
    private final Pose pickUpPose2 = new Pose (24,66, Math.toRadians(-90)); //Constant
    private final Pose shootPose3 = new Pose (35,120, Math.toRadians(140));

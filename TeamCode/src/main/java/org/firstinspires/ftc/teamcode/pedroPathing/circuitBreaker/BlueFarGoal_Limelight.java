...
@Autonomous(name="BlueFarGoal_Limelight", group="Auto", preselectTeleOp="Comb_TwoCon_Teleop_Cam 947 29nov25")
@Disabled
public class BlueFarGoal_Limelight extends OpMode {
    ...
    double shooterVelocityFar = 1920; //2500
    double overRideShooterVelocityFar = 1860;
    Artifact artifact;
    ArtifactNew artifactNew;
    Intake intake;
    ...
    private final Pose shootPose1 = new Pose(56,14, Math.toRadians(107)); //Linear
    ...
    public void autonomousPathUpdate() {
        switch (pathState) {
            ...
            case 1:
                ...
                if(!follower.isBusy()){
                    artifactNew.shootArtifact(shooterPower, shooterVelocityFar,
                                       -1, -1, -1);
                ...
                break;
            case 2:
                if(artifactNew.isArtifactShootingComplete()){
    ...
    public void init() {
        ...
        artifactNew = new ArtifactNew(hardwareMap,this.aprilTagDetected, this.sleepTimer, telemetry);
